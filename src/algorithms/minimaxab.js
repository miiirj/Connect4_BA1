...
export default class MiniMaxAlphaBeta extends Algorithm {
    ...
    play() {
        let i = this.minimaxAB(this.getPlayField(), 5, -Infinity, Infinity, false);
    }
    ...
    minimaxAB(node, depth, alpha, beta, isMaximizingPlayer) {
        let evalVal;
        let value;
        let playersign;
        ...
        if (isMaximizingPlayer) {
            ...
            for (let i = 0; i < playermoves.length; i++) {
                ...
                evalVal = this.minimaxAB(child, depth-1, alpha, beta, false);
            ...
            for (let i = 0; i < playermoves.length; i++) {
                let child = this.getNewBoard(node, playersign, playermoves[i]);
                evalVal = this.minimaxAB(child, depth-1, alpha, beta, true);
